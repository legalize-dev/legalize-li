...
- b) unbeschadet der Regel 28 Abs. 2 Pflanzen oder Tiere, wenn die Ausführung der Erfindung technisch nicht auf eine bestimmte Pflanzensorte oder Tierrasse beschränkt ist;[^11]
...
2) Nach Art. 53 Bst. b werden europäische Patente nicht erteilt für ausschliesslich durch ein im Wesentlichen biologisches Verfahren gewonnene Pflanzen oder Tiere.[^12]
...
2) Die Frist zur Ladung von Beteiligten, Zeugen und Sachverständigen zur Beweisaufnahme beträgt mindestens zwei Monate, sofern diese nicht mit einer kürzeren Frist einverstanden sind. Die Ladung muss enthalten:[^50]
...
3) Die Niederschrift wird von dem Bediensteten, der für die Aufnahme zuständig ist, und dem Bediensteten, der die mündliche Verhandlung oder Beweisaufnahme leitet, durch ihre Unterschrift oder andere geeignete Mittel als authentisch bestätigt.[^51]
...
1) Alle Zustellungen durch Postdienste erfolgen mittels eingeschriebenen Briefs.[^56]
...
1) Kann die Anschrift des Empfängers nicht festgestellt werden oder war die Zustellung nach Regel 126 Abs. 1 auch nach einem zweiten Versuch unmöglich, so wird durch öffentliche Bekanntmachung zugestellt.[^58]
...
2) Von der Weiterbehandlung ausgeschlossen sind die in Art. 121 Abs. 4 genannten Fristen sowie die Fristen nach Regel 6 Abs. 1, Regel 16 Abs. 1 a), Regel 31 Abs. 2, Regel 36 Abs. 2, Regel 40 Abs. 3, Regel 51 Abs. 2 - 5, Regel 52 Abs. 2 und 3, Regeln 55, 56, 58, 59, 62a, 63, 64, Regel 112 Abs. 2 und Regel 164 Abs. 1 und 2.[^62]
...
1) Zu allen europäischen Patentanmeldungen und Patenten werden vom Europäischen Patentamt Akten in elektronischer Form angelegt, geführt und aufbewahrt.[^66]

2) Der Präsident des Europäischen Patentamts bestimmt die erforderlichen technischen und administrativen Bedingungen für die Verwaltung elektronischer Akten nach Massgabe von Abs. 1.[^67]

3) In eine elektronische Akte aufgenommene Unterlagen gelten als Originale. Die ursprünglich eingereichte Papierfassung einer solchen Unterlage wird erst nach Ablauf von mindestens fünf Jahren vernichtet. Diese Aufbewahrungsdauer beginnt am Ende des Jahres, in dem die Unterlage in die elektronische Akte aufgenommen wurde.[^68]
...
1) Die Eintragung des zugelassenen Vertreters in der Liste der zugelassenen Vertreter wird gelöscht, wenn der zugelassene Vertreter dies beantragt oder trotz einer Mahnung den fälligen Jahresbeitrag an das Institut nicht innerhalb von fünf Monaten ab:[^70] entrichtet hat.
...
- d) die Benennungsgebühr zu entrichten, wenn die Frist nach Regel 39 Abs. 1 früher abläuft;[^71]
...
2) Werden die Anspruchsgebühren nicht rechtzeitig entrichtet, so können sie noch innerhalb der Frist nach Regel 161 Abs. 1 bzw. Abs. 2 entrichtet werden. Werden innerhalb dieser Frist geänderte Ansprüche eingereicht, so werden die Anspruchsgebühren auf der Grundlage der geänderten Ansprüche berechnet und sind innerhalb dieser Frist zu entrichten.[^75]
...
2) Wird die Priorität einer früheren Anmeldung in Anspruch genommen und ist das Aktenzeichen der früheren Anmeldung oder deren Abschrift nach Regel 52 Abs. 1 und Regel 53 nicht innerhalb der Frist nach Regel 159 Abs. 1 eingereicht worden, so fordert das Europäische Patentamt den Anmelder auf, das Aktenzeichen oder die Abschrift innerhalb von zwei Monaten einzureichen. Regel 53 Abs. 2 ist anzuwenden.[^76]
...
#### Geltungsbereich der Ausführungsordnung[^78]
...
[^11]: Regel 27 Bst. b abgeändert durch [LGBl. 2018 Nr. 34](https://www.gesetze.li/chrono/2018034000).
...
[^48]: Regel 103 abgeändert durch [LGBl. 2020 Nr. 179](https://www.gesetze.li/chrono/2020179000). Die geänderte Regel 103 gilt für Beschwerden, die am 1. April 2020 anhängig sind und für Beschwerden, die nach diesem Zeitpunkt eingelegt werden.

[^49]: Regel 117 abgeändert durch [LGBl. 2021 Nr. 80](https://www.gesetze.li/chrono/2021080000).

[^50]: Regel 118 Abs. 2 abgeändert durch [LGBl. 2021 Nr. 80](https://www.gesetze.li/chrono/2021080000).

[^51]: Regel 124 Abs. 3 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^52]: Regel 125 Abs. 1 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^53]: Regel 125 Abs. 2 Bst. a abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^54]: Regel 125 Abs. 2 Bst. b abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^55]: Regel 126 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^56]: Regel 126 Abs. 1 abgeändert durch [LGBl. 2019 Nr. 298](https://www.gesetze.li/chrono/2019298000).

[^57]: Regel 127 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^58]: Regel 129 Abs. 1 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^59]: Regel 133 Abs. 1 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^60]: Regel 134 Abs. 1 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^61]: Regel 134 Abs. 5 abgeändert durch [LGBl. 2015 Nr. 90](https://www.gesetze.li/chrono/2015090000).

[^62]: Regel 135 Abs. 2 abgeändert durch [LGBl. 2015 Nr. 89](https://www.gesetze.li/chrono/2015089000).

[^63]: Regel 137 abgeändert durch [LGBl. 2010 Nr. 39](https://www.gesetze.li/chrono/2010039000). Die geänderte Regel 137 gilt für europäische Patentanmeldungen, zu denen der europäische Recherchenbericht oder der ergänzende europäische Recherchenbericht ab dem 1. April 2010 erstellt wird.

[^64]: Regel 141 abgeändert durch [LGBl. 2015 Nr. 88](https://www.gesetze.li/chrono/2015088000).

[^65]: Regel 142 Abs. 2 abgeändert durch [LGBl. 2020 Nr. 270](https://www.gesetze.li/chrono/2020270000). Die geänderte Regel 142 Abs. 2 gilt für alle Verfahren, die am 1. Juli 2020 bereits unterbrochen sind oder ab diesem Datum unterbrochen werden.

[^66]: Regel 147 Abs. 1 abgeändert durch [LGBl. 2017 Nr. 129](https://www.gesetze.li/chrono/2017129000).

[^67]: Regel 147 Abs. 2 abgeändert durch [LGBl. 2017 Nr. 129](https://www.gesetze.li/chrono/2017129000).

[^68]: Regel 147 Abs. 3 abgeändert durch [LGBl. 2017 Nr. 129](https://www.gesetze.li/chrono/2017129000).

[^69]: Regel 153 Sachüberschrift abgeändert durch [LGBl. 2015 Nr. 88](https://www.gesetze.li/chrono/2015088000).

[^70]: Regel 154 Abs. 1 abgeändert durch [LGBl. 2019 Nr. 140](https://www.gesetze.li/chrono/2019140000).

[^71]: Regel 159 Abs. 1 Bst. d abgeändert durch [LGBl. 2015 Nr. 88](https://www.gesetze.li/chrono/2015088000).

[^72]: Regel 160 abgeändert durch [LGBl. 2015 Nr. 88](https://www.gesetze.li/chrono/2015088000).

[^73]: Regel 161 abgeändert durch [LGBl. 2011 Nr. 342](https://www.gesetze.li/chrono/2011342000).

[^74]: Regel 162 abgeändert durch [LGBl. 2011 Nr. 342](https://www.gesetze.li/chrono/2011342000).

[^75]: Regel 162 Abs. 2 abgeändert durch [LGBl. 2017 Nr. 129](https://www.gesetze.li/chrono/2017129000).

[^76]: Regel 163 Abs. 2 abgeändert durch [LGBl. 2015 Nr. 88](https://www.gesetze.li/chrono/2015088000).

[^77]: Regel 164 abgeändert durch [LGBl. 2015 Nr. 89](https://www.gesetze.li/chrono/2015089000).

[^78]: Siehe Geltungsbereich des Europäischen Patentübereinkommens.
