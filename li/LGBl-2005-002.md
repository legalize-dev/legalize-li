...
- c) das Berufungsverfahren sowie die personelle Ausstattung (Leitung, Lehrpersonal und weitere Mitarbeiter);[^14]

- d) die Studienordnung (einschliesslich der Bezeichnung der Titel und Grade);[^15]

- e) die Infrastruktur;

- f) die Zusammenarbeit mit anderen Hochschulen des In- und Auslandes; und

- g) die Mitwirkung von Hochschulangehörigen und das System zur Sicherung und Entwicklung der Qualität; sowie[^16]

- h) gegebenenfalls die Begründung, weshalb einzelne Aufgaben der Hochschule ausnahmsweise nicht auf dem Gebiet des Fürstentums Liechtenstein erfüllt werden.[^17]
...
4) Die Regierung regelt das Nähere unter Berücksichtigung allgemein anerkannter Akkreditierungskriterien mit Verordnung.[^18]
...
- b) Akkreditierung oder Durchführung einer externen Evaluation durch ein vom Schulamt bestimmtes Gremium auf Kosten der Hochschule;[^20]
...
2) Die unter diesem Status verliehenen Hochschulqualifikationen sind staatlich anerkannt.[^21]
...
- c) Akkreditierung oder Vorlage des Evaluationsberichts nach Art. 10 Abs. 1 Bst. b über die erfolgreiche Umsetzung des Konzepts nach Art. 8 Abs. 2;[^22]
...
##### 3. European Credit Transfer System (ECTS)[^31]
...
3) Ausländische Maturaausweise oder vergleichbare Abschlüsse sind nach Massgabe von Gegenrechtsvereinbarungen liechtensteinischen Ausweisen gleichwertig. Andere Ausweise sind einer Gleichwertigkeitsprüfung zu unterziehen.[^37]

4) Ohne Maturaausweis oder vergleichbaren Abschluss kann ausnahmsweise zugelassen werden, wer seine Studierfähigkeit und seine Eignung für den von ihm gewünschten Studiengang durch andere Nachweise belegt.[^38]
...
- b) die Bedingungen und das Verfahren der Zulassung ohne Maturaausweis oder vergleichbaren Abschluss.[^39]
...
#### E. Lehrbefähigung und Lehrpersonal[^41]
...
1) Personen, die an der Hochschule unterrichten und deren Bestellung nicht im Berufungsverfahren erfolgt ist, gelten als weiteres Lehrpersonal.[^50]
...
#### F. Hochschulqualifikationen und Ehrentitel[^51]

##### Art. 34

**Geschützte Hochschulqualifikationen[^52]**

1) Es werden folgende geschützte Hochschulqualifikationen unterschieden:[^53]
...
- b) kann für Weiterbildungsstudiengänge mit Verordnung geschützte Abschlussqualifikationen bestimmen.[^55]
...
2) Die hochschulähnliche Einrichtung hat ihre Aufgaben auf dem Gebiet des Fürstentums Liechtenstein zu erfüllen. Von diesem Grundsatz kann in begründeten Fällen hinsichtlich einzelner Aufgaben abgewichen werden.[^62]
...
***Hochschulprofessoren*[^46]**

**Befugnis zur Verleihung[^56]**
...
1) Auf vor Inkrafttreten dieses Gesetzes[^66]begonnene Studiengänge an von der Regierung bewilligten Hochschulen findet längstens während drei Jahren nach Inkrafttreten dieses Gesetzes das bisherige Recht Anwendung.
