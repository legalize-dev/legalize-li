...
1) Dieses Protokoll tritt am ersten Tag des Monats in Kraft, der auf einen Zeitabschnitt von drei Monaten nach dem Tag folgt, an dem fünf Vertragsstaaten des Übereinkommens nach Art. 4 ihre Zustimmung ausgedrückt haben, durch das Protokoll gebunden zu sein.
...
- c) jeden Zeitpunkt des Inkrafttretens dieses Protokolls nach den Art. 5, 6 und 7;

- d) jede Kündigung;

- e) jede andere Handlung, Notifikation oder Mitteilung im Zusammenhang mit diesem Protokoll.

### Geltungsbereich des Zusatzprotokolls am 1. Juni 2006
