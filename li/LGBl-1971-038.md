...
- b) Vorliegen eines vom Bauamt erstellten und von der Gemeinde genehmigten Abbauplanes;
...
1) Das Konzessionsgesuch ist beim Bauamt einzureichen.
...
1) Das Bauamt weist unter besonderer Berücksichtigung der in Art. 1 Abs. 3 dieser Verordnung aufgestellten Voraussetzungen die Ausbeutungsstelle zu.

2) Es kann, wenn es rüfebautechnisch als notwendig erscheint, dem Konzessionär eine andere Ausbeutungsstelle zuweisen.

3) Das Bauamt hat die Ausbeutungsstellen zu kontrollieren und die Wertigkeit des Gesteinsmaterials zu bestimmen.

##### Art. 7

Sofern für die Weiterverarbeitung des Gesteinsmaterials auf der Ausbeutungsstelle feste Anlagen wie Wasch- und Brechanlagen verwendet werden, ist vorgängig eine BaubewilIigung des Bauamtes und eine Betriebsanlagegenehmigung der Regierung einzuholen. Hiefür ist ein Vertrag mit dem Grundeigentümer notwendig.

##### Art. 8

1) Der Konzessionär ist verpflichtet, sämtliches Gesteinsmaterial, das bei den Ausbeutungsstellen anfällt, zu entnehmen. Er hat im Einvernehmen mit dem Bauamt das nicht verwertbare Gesteinsmaterial an geeigneter Stelle zu deponieren. Für Entnahmen und Deponien ausserhalb des Rüfelaufes bedarf es der Zustimmung des betreffenden Grundeigentümers.

2) Die Kosten für das Laden und den Transport des Gesteinsmaterials trägt der Konzessionär.

3) Das Bauamt kann bei akuter Gefahr ohne vorherige Mitteilung an den Konzessionär Räumungen anordnen.
...
1) Der Konzessionär ist verpflichtet, eine genaue Aufstellung über die Menge des ausgebeuteten Gesteinsmaterials, den Verwendungszweck und die Abnehmer zu führen und dem Bauamt jederzeit Einsicht zu gewähren. Hiefür sind tägliche Rapporte zu führen und vom amtlichen Aufsichtsorgan zu zeichnen.

2) Nähere Einzelheiten bestimmt das Bauamt.

##### Art. 10

1) Das auf den öffentlichen Deponien liegende Gesteinsmaterial ist Eigentum des Landes bzw. der betreffenden Gemeinde.

2) In den Verbauungs- bzw. Einzugsgebieten der Rüfen dürfen Deponien nur mit ausdrücklicher Genehmigung des Bauamtes errichtet werden. Es ist ausserdem die Bewilligung des Grundeigentümers einzuholen.
