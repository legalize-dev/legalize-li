...
- a) das Ausladen, Unterbringen und Betreuen von Tieren in Schlachtbetrieben;[^1]
...
- b) das Wartenlassen oder Aufstallen der Tiere im Schlachtbetrieb (Unterbringung); und[^4]
...
- 2.3 Bei Rindern, mit Ausnahme von Wasserbüffeln, Equiden und Schweinen, darf der Schussapparat nicht am Hinterkopf angesetzt werden.
...
- a) bei Equiden: genau senkrecht zur Stirnfläche auf der Mittellinie, 2 cm oberhalb des Kreuzungspunktes der diagonalen Verbindungslinien zwischen Augenmitte und Mitte des gegenüberliegenden Ohransatzes (Ohrbasis);
...
- a) 60 Sek. bei Rindern, Schafen, Ziegen und Equiden;
...
- 5.3 Die analoge Wirkung von anderen als den in den Ziff. 5.1 und 5.2 angegebenen Parametern muss durch den Betreiber des Schlachtbetriebes mit einem Gutachten nach Art. 24 Abs. 2 einer unabhängigen wissenschaftlichen Fachstelle nachgewiesen werden.
...
- 2.5 Die analoge Wirkung von anderen als den in den Ziff. 2.3 und 2.4 genannten Parametern muss durch den Betreiber des Schlachtbetriebes mit einem Gutachten nach Art. 24 Abs. 2 einer unabhängigen wissenschaftlichen Fachstelle nachgewiesen werden.
...
- b) Die Beförderungsvorrichtung sowie die Kammer, in der die Schweine dem CO2 ausgesetzt werden, müssen mit indirektem Licht beleuchtet sein.
...
- 1.3 Die Mindestkonzentration an CO2 muss 84 Volumenprozente betragen. Die Mindestverweildauer in der CO2-Atmosphäre liegt bei 100 Sek.
...
- a) beim Eintauchen des Kopfes des Tieres in eine CO2-Konzentration von 84 Volumenprozent;
...
- 3.2.1 Die Schweine müssen unverzüglich und möglichst ohne Zwischenstopp, spätestens jedoch 20 Sek. nach dem Einschleusen des ersten Tieres in die Anlage, in die CO2-Atmosphäre mit der in Ziff. 7 aufgeführten Mindestkonzentration befördert werden.
...
- 4.2 In Systemen mit mehr als einem Halt in der CO2-Atmosphäre muss die Konzentration am tiefsten Punkt der Anlage mehr als 90 Volumenprozente in Kopfhöhe der Tiere betragen.
...
- 5.2 Der Erfolg der Betäubung ist verteilt über jeden Schlachttag stichprobenweise zu überprüfen. Dabei sind die Leitsymptome einer wirksamen CO2-Betäubung unmittelbar vor Beginn der Entblutung zu kontrollieren. Mangelhafte Betäubungen müssen dokumentiert werden.
...
- 7.2 Das maximal zulässige Zeitintervall vom Auftauchen aus der CO2-Atmosphäre bis zum Setzen des Entblutungsschnitts gilt für jedes einzelne Tier; bei mehreren Tieren in einer Gondel gilt es für das zuletzt zur Entblutung kommende Tier.

- 7.3 Die analoge Wirkung anderer Werte für die vorgegebenen Parameter muss durch den Betreiber des Schlachtbetriebes mit einem Gutachten nach Art. 24 Abs. 2 einer unabhängigen wissenschaftlichen Fachstelle nachgewiesen werden.
...
- a) bei Equiden: senkrecht zur Stirnfläche auf der Mittellinie, im Kreuzungspunkt der diagonalen Verbindungslinien zwischen der Augenmitte und der Mitte des gegenüberliegenden Ohransatzes (Ohrbasis);
