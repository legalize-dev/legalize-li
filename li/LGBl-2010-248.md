...
1) Das steuerliche Amtshilfe- und Compliance-Programm bezweckt die Einführung von Verfahren zur Identifizierung von im Vereinigten Königreich mutmasslich steuerpflichtigen Personen.

2) Es umfasst:

- a) das Mitteilungsverfahren;

- b) das Bestätigungsverfahren;

- c) das Prüfungsverfahren; und

- d) das Kontrollverfahren.
...
1) Ein Finanzintermediär ist verpflichtet, die relevanten Personen, gegenüber welchen er relevante Dienstleistungen erbringt, zu identifizieren. Die Einzelheiten einschliesslich der von den Finanzintermediären bei der Identifikation zu wahrenden Fristen regelt die Regierung mit Verordnung.

2) Der Finanzintermediär teilt der nach Abs. 1 identifizierten Person mit, dass:

- a) er weiss oder Grund hat anzunehmen, dass die Person eine relevante Person ist, wobei die Gründe für diese Kenntnis oder Annahme darzulegen sind;

- b) die relevante Person innerhalb von 18 Monaten ab dem Datum dieser schriftlichen Mitteilung:

- aa) den Finanzintermediär davon zu überzeugen hat, dass sie keine relevante Person ist; oder

- bb) dem Finanzintermediär jeweils binnen 30 Tagen nach Erhalt eine Registrierungsbestätigung und eine Offenlegungsbestätigung der zuständigen Behörde des Vereinigten Königreichs vorzulegen hat; oder

- cc) dem Finanzintermediär ein Dokument nach Art. 9 Abs. 2 vorzulegen hat; und

- c) der Finanzintermediär, sofern er keinen Antrag auf Durchführung des Prüfungsverfahren gestellt hat, seine Dienstleistungen innerhalb von sechs Monaten nach Ablauf der in Bst. b erwähnten Frist einzustellen hat, wobei eine allenfalls von der zuständigen Behörde des Vereinigten Königreichs gewährte Fristverlängerung im dortigen Bestätigungsverfahren berücksichtigt wird.

3) Ist die identifizierte Person nicht die Vertragspartei des Finanzintermediärs, informiert dieser die für das relevante Vermögen zuständige Vertragspartei.

4) Die Mitteilung nach Abs. 2 hat schriftlich innerhalb von drei Monaten nach der Identifizierung zu erfolgen; erweist sich eine Mitteilung innerhalb dieser Frist als nicht praktikabel, so hat diese so bald wie möglich zu geschehen. Die Mitteilung kann entfallen, wenn der Finanzintermediär weiss, dass die betreffende Person bereits entsprechend informiert worden ist.
...
1) Finanzintermediäre, die nicht auf der Kontrollliste geführt werden, werden von Wirtschaftsprüfern oder Revisionsgesellschaften mittels eines separaten Prüfverfahrens im Rahmen der ordentlichen Kontrollen nach dem Sorgfaltspflichtgesetz kontrolliert.
...
Soweit dieses Gesetz nichts anderes bestimmt, richtet sich das Verfahren nach dem Gesetz über die allgemeine Landesverwaltungspflege.

##### Art. 22

**Beschwerde**

Gegen Verfügungen des Prüfungsausschusses kann binnen 14 Tagen ab Zustellung Beschwerde beim Verwaltungsgerichtshof erhoben werden.
