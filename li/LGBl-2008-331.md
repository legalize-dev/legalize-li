...
5) Gegenüber berufsmässigen Parteienvertretern, juristischen Personen, Personengesellschaften und Einzelfirmen wird die Zustellung unabhängig vom Zeitpunkt der Kenntnisnahme durch den Empfänger oder dessen Vertreter im Sinne des Art. 16 Abs. 3 wirksam.
...
1) Zustellungen an Personen, deren Abgabestelle unbekannt ist, oder an eine Mehrheit von Personen, die der Behörde nicht bekannt sind, können, wenn es sich nicht um ein Strafverfahren handelt, kein Zustellungsbevollmächtigter bestellt ist und nicht nach Art. 8 vorzugehen ist, durch Veröffentlichung auf der Webseite der Behörde, dass ein zuzustellendes Dokument zur Ausfolgung bereit liegt, vorgenommen werden.

2) Findet sich der Empfänger zur Empfangnahme des Dokuments (Art. 26) nicht ein, so gilt, wenn gesetzlich nicht anderes bestimmt ist, die Zustellung als bewirkt, wenn seit der Veröffentlichung auf der Webseite der Behörde 14 Tage verstrichen sind. Auf diese Rechtsfolge ist in der Veröffentlichung hinzuweisen.

3) Die Behörde kann die öffentliche Bekanntmachung in anderer geeigneter Weise, insbesondere durch Publikation in den amtlichen Kundmachungsorganen, ergänzen.
...
**b) an einer elektronischen Zustelladresse**

1) Zustellungen ohne Zustellnachweis können auch an eine elektronische Zustelladresse erfolgen.

2) Bei der Zustellung an eine elektronische Zustelladresse gilt das Dokument mit dem Zeitpunkt des Einlangens beim Empfänger als zugestellt. Bestehen Zweifel darüber, ob bzw. wann das Dokument beim Empfänger eingelangt ist, hat die Behörde Tatsache und Zeitpunkt des Einlangens von Amts wegen festzustellen.
...
[^1]: Überschrift vor Art. 16 abgeändert durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^2]: Art. 29 Sachüberschrift abgeändert durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^3]: Überschrift vor Art. 30 eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^4]: Art. 30 abgeändert durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^5]: Art. 30a eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^6]: Art. 30b eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^7]: Art. 30c eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^8]: Art. 30d eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).

[^9]: Art. 31 Bst. f eingefügt durch [LGBl. 2011 Nr. 576](https://www.gesetze.li/chrono/2011576000).
