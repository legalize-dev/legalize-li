...
- h) die Bearbeitung und die Aufbewahrungsdauer der Daten;

- i) die Rechte der betroffenen Personen;

- k) die Bekanntgabe von Daten an Drittstaaten oder internationale Organisationen; und
...
1) Das Ausländer- und Passamt ist Inhaber der Daten, die es bei der Erfassung eines Visumgesuchs eingegeben hat.

2) Die Daten, die bei einem Entscheid zur Visumerteilung oder bei Verlängerung des Visums eingegeben werden, hat ebenfalls das Ausländer- und Passamt inne.
...
2) Die Abfrage- und Zugriffsberechtigungen der einzelnen Organisationseinheiten werden in einem Bearbeitungsreglement nach Art. 3 Abs. 2 geregelt.
...
3) Die Abfrageberechtigungen der einzelnen Organisationseinheiten werden in einem Bearbeitungsreglement nach Art. 3 Abs. 2 geregelt.
...
### VI. Datenbearbeitung und Datensicherheit
...
1) Das Ausländer- und Passamt stellt die Richtigkeit der Daten und die Rechtmässigkeit der Datenbearbeitung im N-VIS sicher.

2) Bestehen Anhaltspunkte dafür, dass Daten unrichtig sind oder unrechtmässig bearbeitet wurden, so ist dies dem Ausländer- und Passamt unverzüglich mitzuteilen.

3) Das Ausländer- und Passamt unternimmt unverzüglich die erforderlichen Schritte, sobald ihm unrichtige Daten oder eine unrechtmässige Datenbearbeitung zur Kenntnis gebracht wurden.
...
1) Die im N-VIS und im C-VIS bearbeiteten Daten dürfen Drittstaaten oder internationalen Organisationen nicht bekannt gegeben werden.

2) Folgende Daten des C-VIS über eine Person dürfen Drittstaaten oder internationalen Organisationen im Sinn des Anhangs der VIS-Verordnung im Einzelfall zum Nachweis der Identität eines Drittstaatsangehörigen, auch zum Zweck der Rückführung, bekannt gegeben werden, wenn die Bedingungen nach Art. 31 der VIS-Verordnung erfüllt sind:
...
3) Die Daten des N-VIS können in einem Einzelfall nach Art. 72 AuG bekannt gegeben werden.
...
2) Das Ausländer- und Passamt legt im Bearbeitungsreglement nach Art. 3 Abs. 2 die organisatorischen und technischen Massnahmen gegen unbefugtes Bearbeiten der Daten fest und regelt die automatische Protokollierung der Datenbearbeitung und der Dateneinsicht.
...
2) Das Ausländer- und Passamt kann auch Statistiken zum C-VIS erstellen. Die Zugriffsberechtigungen zu diesem Zweck werden in einem Bearbeitungsreglement nach Art. 3 Abs. 2 geregelt.
...
1) Der Datenschutzstelle obliegt die Aufsicht über die Bearbeitung von Personendaten.
...
[^1]: In Kraft getreten am 19. Dezember 2011 ([LGBl. 2011 Nr. 563](https://www.gesetze.li/chrono/2011563000)).
